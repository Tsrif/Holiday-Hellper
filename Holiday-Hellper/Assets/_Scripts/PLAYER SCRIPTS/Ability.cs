...
public class Ability : MonoBehaviour
{
    ...
    {
        if (gameState == GameState.PAUSED || gameState == GameState.WIN || gameState == GameState.LOSE || playerState == PlayerState.CARRYING || playerState == PlayerState.CAPTURING || okayToUse)
        {
            return false;
        }
        return true;
